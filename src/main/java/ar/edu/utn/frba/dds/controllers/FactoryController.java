...
public class FactoryController {
  ...
  public static Object controller(String nombre) {
    ...
    switch (nombre) {
      ...
      case "Incidentes" : controller = new IncidenteController(RepositorioPrestaciones.getInstance(),RepositorioComunidades.getInstance(), RepositorioIncidentes.getInstance(), RepositorioMiembros.getInstance()); break;
